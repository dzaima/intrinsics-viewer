...
download-riscv: data/rvv_base-5.json data/v-spec.html
...
data/rvv_base-5.json:
	mkdir -p data
	curl -L 'https://github.com/dzaima/rvv-intrinsic-doc/releases/download/v7/rvv_base.json' > "$@"
